                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px', fontSize: '8px', opacity: 0.7 }}>
                  <div title={currentSource === 'cmc' ? 'CoinMarketCap' : 'CoinGecko'} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '12px', height: '12px' }}>
                    {currentSource === 'cmc' ? (
                      ...
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="#ef7615">
                        <path d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm3.15 12.78c-1.62 2.4-5.16 3.15-7.92 1.89-1.11-.54-1.98-.54-2.67 0-.51.4-.73.99-.62 1.51.35 1.62 1.89 2.83 4.05 3.37 4.59.35 8.64-1.89 9.63-5.4.27-1.08 0-1.78-.81-2.16-.81-.37-2.02-.05-2.67.89l-.27.41c-.51.81-1.08 1.62-2.29 1.62-1.35 0-1.89-.78-2.13-1.89-.15-.75-.27-1.62.27-2.29.67-1.08 2.05-1.35 3.37-1.35 1.35 0 2.16.27 2.9.78.78.54 1.35 1.35 1.62 2.29l.27 1.08c.15.75.78 1.35 1.62 1.35.84 0 1.49-.6 1.62-1.35.27-1.35.27-2.7-.27-3.91z"/>
                      </svg>
                    )}
                  </div>
